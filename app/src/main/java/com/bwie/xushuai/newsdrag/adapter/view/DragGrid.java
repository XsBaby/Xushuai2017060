package com.bwie.xushuai.newsdrag.adapter.view;
...
import com.bwie.xushuai.newsdrag.adapter.DragAdapter;
import com.bwie.xushuai.newsdrag.adapter.tools.DataTools;
                ...
                builder.setSingleChoiceItems(arr, -1, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (which == 0) {//选择wifi
                            ...
                            Toast.makeText(getContext(), "跳转wifi界面", Toast.LENGTH_SHORT).show();
...
//                    子View的所有父ViewGroup会跳过onInterceptTouchEvent回调
    ...
    protected void downloadApk() {
        ...
        String url = "http://imtt.dd.qq.com/16891/79E01F3A25B7C41E8863FD926CC4B9CA.apk?fsname=com.tencent.mobileqq_7.0.0_676.apk&csr=97c2";
        //apk下载地址，放置apk的路径
        //1.获取sd卡路径
        String path = Environment.getExternalStorageDirectory().getPath() + "/my.apk";
        //2.发送请求，获取apk，并放到指定路径
        RequestParams rp = new RequestParams("http://imtt.dd.qq.com/16891/6FF2E89F6710638DB43B17CE0A2D7A14.apk?fsname=com.tencent.qqpimsecure_7.0.0_1171.apk&csr=97c2");
        ...
        x.http().get(rp, new Callback.ProgressCallback<File>() {
            ...
            public void onSuccess(File result) {
                Toast.makeText(getContext(), "下载完成,开始安装!", Toast.LENGTH_SHORT).show();
                installApk(result);
            }
